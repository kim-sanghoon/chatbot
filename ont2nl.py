...
nlDict = {
    ...
    'EnableShadingSystemAction': 'the shades will be closed. ',
    'DisableShadingSystemAction': 'the shades will be opened. ',
    'SetShadingAction': 'the shade position will be changed. ',
    ...
    'AddAlarmAction': 'an alarm for you will be added. ',
    'TurnAlarmOffAction': 'the alarm will be turned off. ',
...
def speak_mashup(m):
    ...
    ret = ""
    initWords, i = ["If ", "First, ", "Second, ", "Third, ", "Next, ", "After that, ", "Then, "], 0
